...
namespace SmartCardCheckerGui
{
    internal class DllConst
    {
        ...
        public const int SCARD_STATE_UNKNOWN = 0x00000004;
        public const int SCARD_STATE_UNAVAILABLE = 0x008;
        public const int SCARD_STATE_EMPTY = 0x00000010;
        public const int SCARD_STATE_PRESENT = 0x00000020;
        public const int SCARD_STATE_ATRMATCH = 0x0040;
        public const int SCARD_STATE_EXCLUSIVE = 0x0080;
        public const int SCARD_STATE_INUSE = 0x0100;
        public const int SCARD_STATE_MUTE = 0x0200;
        public const int SCARD_STATE_UNPOWERED = 0x0400;
